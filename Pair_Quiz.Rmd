...
<p> We failed to reject the null hypothesis for $\beta_1$. On the other hand, the null hypothesis for $\beta_2$ is rejected. Contrast have a correlation with useful range. </p>
